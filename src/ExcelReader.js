...
function ExcelReader() {
  ...
  const fetchFormulas = async (worksheet, headers) => {
    ...
    console.log("Formula data extracted:", formulaData);
    console.log("Headers to be sent to backend:", headers);
    ...
    try {
      ...
      if (response.data) {
        console.log("Interpreted formulas received:", response.data);
